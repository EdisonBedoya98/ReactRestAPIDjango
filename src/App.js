      ...
      <div>
        <Card style={{ width: "30rem" }}>
          <Card.Body>
            ...
            <Card.Text>
              La aplicación MIDANSE clasifica una opinión como positiva o
            ...
            <Card.Text>
              ...
              a la habitación que nos dieron " <b>(Negativa)</b>{" "}
            </Card.Text>{" "}
            <Card.Text>
              "Todo muy bien, ubicación, limpieza, decoración, tamaño de la
              habitación " <b>(Positiva)</b>{" "}
            </Card.Text>{" "}
            <Card.Body>
